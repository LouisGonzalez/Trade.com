...
export class ChatComponent implements OnInit {
  ...
  // @Input() hola(): void{console.log("Si dio xD");};
  ...
  constructor(private emmitChatService:EmmitChatService, public chatService:ChatService, private componentFactoryResolver: ComponentFactoryResolver) {
    this.message = "";
    this.user = "";
    this.username = "";
    this.username2 = "";
  ...
  initChat(){
    this.emmitChatService.invocationChat.subscribe( (data) => {
      
      
      console.log(data);
      this.username = data.cuenta_uno;
      this.username2 = data.cuenta_dos;
      this.createChat2();
    }
      // res => {
    ...
    // console.log("Si dio xD");
    // if(this.emmitChatService.){
